...
<body>
            ...
            <div class="row">
                <div>  
                   <div class="d-none d-lg-block float-lg-left mr-5" style="max-width:420px;">
                    ...
                    <?php
                        if (($section->lien_site_festisol) != null ){
                            echo '<a href="<?= $section->lien_site_festisol ?>" target="_blank" class="btn btn-info w-100 text-truncate my-3">Direction le site de Festisol !</a>';
                        }
                    ?>
    ...
    <!--FESTISOL end -->
                           ...
                           <!-- hr flag start BESOIN DANS LA BOUCLE D AJOUT a i =1 a dessus
